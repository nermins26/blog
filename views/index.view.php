                ...
                <div class="col-6">
                    ...
                    <div class="card mb-5">
                        ...
                        <?php if(isset($_SESSION['loggedUser']) && ($single->user_id == $_SESSION['loggedUser']->id)): ?>
                            <span><a href="delete_post.php?id=<?php echo $single->id; ?>" class="btn btn-sm btn-danger float-right">Delete</a></span>
                        <?php endif ?>
                        
                    </div>
                        <div class="card-body">
                        <?php echo $single -> description; ?><br>
                        <a href="single.php?id=<?php echo $single->id ?>" class="btn btn-sm btn-info mt-4">Vidi više</a>
                        </div>
